            ...
            <div class="mb-8 bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    @foreach ($acList as $item)
                        <a href="#">
                            <div class="flex items-center p-4 border rounded-lg active:bg-green-100 border-green-300 shadow hover:bg-green-100">
                                <div class="mr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium">
                                        ...
                                        @endphp
                                        |
                                        <span class="text-slate-600">{{ $item->electrical_power }}kWh</span></p>
                                </div>
                            </div>
                        </a>
                    @endforeach
