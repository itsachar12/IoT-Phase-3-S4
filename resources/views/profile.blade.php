        ...
        <div class="flex flex-col items-center space-y-4">
            <div class="w-32 h-32 bg-gray-300 rounded-full flex items-center justify-center overflow-hidden shadow-lg ">
                @if (Auth::user()->picture)
                    <img src="{{ asset('ProfilePicture/' . auth()->user()->picture) }}" alt="User Picture"
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="{{ route('profile.picture') }}" method="post"
                    ...
                    <div class="grid gap-4 mb-4 ">
                        <div class="col-span-1">
                            <label for="picture"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">File Picture</label>
