            ...
            <div class="flex items-center relative">
               ...
               <div id="dropdown-user" class="hidden absolute right-0 top-16 w-48 bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600">
                  ...
                  <ul class="py-1" role="none">
                     ...
                     <li><a href="/logout" onclick="confirmLogout(event)" class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Logout</a></li>
                  </ul>
               </div>
            </div>
      ...
      <ul class="space-y-2 font-medium py-4">
         ...
         <li>
            <a href="/appliences" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-green-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Appliances</span>
            </a>
         </li>
         <li>
