<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 shadow">
   <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
         <div class="flex items-center space-x-3">
            ...
            <!-- Logo -->
            <img src="{{ url('/image/g1.png') }}" alt="GX DOJO Logo" class="h-10 w-10">

            <!-- Text Section -->
            <div class="flex flex-col items-center justify-center">
               <h1 class="text-xl font-extrabold text-green-800">GX DOJO</h1>
               <p class="text-sm font-semibold text-green-600 tracking-wide">Green Energy System</p>
            </div>
         </div>
         ...
         <div class="flex items-center space-x-8">
            ...
            <div class="flex items-center relative">
               <button id="dropdownButton" type="button" class="flex items-center text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
               ...
               <div id="dropdown-user" class="hidden absolute right-0 top-12 w-48 bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600">
                  ...
                  <ul class="py-1" role="none">
                     ...
                     <li><a href="#" class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Logout</a></li>
                  </ul>
               </div>
            </div>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="/dashboard" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-green-100 dark:hover:bg-gray-700 group">
